...
#define KEY_KP_MULTIPLY		0x37    /* * on numeric keypad */
...
#define KEY_KP_EQUALS		0x8D    /* = on numeric keypad (NEC PC98) */
...
#define KEY_KP_ENTER		0x9C    /* Enter on numeric keypad */
#define KEY_RCONTROL		0x9D
#define KEY_KP_COMMA		0xB3    /* , on numeric keypad (NEC PC98) */
#define KEY_KP_DIVIDE		0xB5    /* / on numeric keypad */
...
#define KEY_LSYSTEM			0xDB    /* Left Windows key */
#define KEY_RSYSTEM			0xDC    /* Right Windows key */
#define KEY_MENU			0xDD    /* AppMenu key */




/*
#define KEY_PRINTSCREEN		0x11
#define KEY_PAUSE			0x12
#define KEY_CAPSLOCK		0x13
*/
